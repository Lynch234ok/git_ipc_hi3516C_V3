...
static unsigned char util_DecodeByte(char ch)
{
	unsigned int i;
    static const char key[] = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/";
...
int util_QuotedPrintableDecode(char * lpSource)
{
    char * p = lpSource;
    char * q = lpSource;
