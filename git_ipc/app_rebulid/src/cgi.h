...
extern int CGI_cpu_temperature(HTTPD_SESSION_t* session);
...
extern int CGI_system_upgrade2(LP_HTTP_CONTEXT context);
extern int CGI_system_upgrade_get_rate2(LP_HTTP_CONTEXT context);

extern int CGI_flv_live_view2(LP_HTTP_CONTEXT context);
extern int FLV_http_live(LP_HTTP_CONTEXT context);
