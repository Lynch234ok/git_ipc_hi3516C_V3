...
typedef struct NVP_USERS_CONFIG{
	char username[64];
	char password[64];
}stNVP_USERS_CONFIG,*lpNVP_USERS_CONFIG;
typedef struct NVP_AUTHORIZATIONS_CONFIG{
	int usernum;
	stNVP_USERS_CONFIG users[NVP_MAX_USERS];
}stNVP_AUTHORIZATIONS_CONFIG,*lpNVP_AUTHORIZATIONS_CONFIG;
...
typedef struct NVP_PROFILE_CHN
{
	...
	stNVP_AUTHORIZATIONS_CONFIG auth;
