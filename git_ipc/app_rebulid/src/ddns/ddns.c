...
{
	prctl(PR_SET_NAME, "ddns_daemon");
	// FIXME
	if(_ddns->ddns_para.provider==kNSDK_NETWORK_DDNS_PROVIDER_DYNDDNS){
	...
	}else if(_ddns->ddns_para.provider==kNSDK_NETWORK_DDNS_PROVIDER_NOIP){
	...
	}else if(_ddns->ddns_para.provider==kNSDK_NETWORK_DDNS_PROVIDER_3322){
	...
	}else if(_ddns->ddns_para.provider==kNSDK_NETWORK_DDNS_PROVIDER_CHANGEIP){
