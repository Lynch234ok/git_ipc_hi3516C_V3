...
#define SENSOR_SC1145_WIDTH (1280)
#define SENSOR_SC1145_HEIGHT  (720)
#define SC1145_CHECK_DATA_LSB	(0x11)//0x3107
#define SC1145_CHECK_DATA_MSB	(0x45)//0x3108
...
static HI_S32 sc1145_get_ae_default(AE_SENSOR_DEFAULT_S *pstAeSnsDft)
{
...
static HI_VOID sc1145_fps_set(HI_FLOAT f32Fps, AE_SENSOR_DEFAULT_S *pstAeSnsDft)
{
...
#if 1//sc1145 denoise logic-20160618
		HI_U16 u16Temp = u32VblankingLines - 0x2ee;
		SENSOR_I2C_WRITE(0x3336, (u16Temp>>8)&0xff);
		SENSOR_I2C_WRITE(0x3337, u16Temp&0xff);
	
		SENSOR_I2C_WRITE(0x3338, (u32VblankingLines>>8)&0xff);
		SENSOR_I2C_WRITE(0x3339, u32VblankingLines&0xff);
...
static HI_VOID sc1145_slow_framerate_set(HI_U32 u32FullLines,
...
#if 1//sc1145 denoise logic-20160618
	HI_U16 u16Temp = u32FullLines - 0x2ee;
	SENSOR_I2C_WRITE(0x3336, (u16Temp>>8)&0xff);
	SENSOR_I2C_WRITE(0x3337, u16Temp&0xff);
...
static HI_VOID sc1145_inttime_update(HI_U32 u32IntTime)
{
...
static HI_VOID sc1145_again_calc_table(HI_U32 *pu32AgainLin, HI_U32 *pu32AgainDb)
{
    int i;
...
static HI_VOID sc1145_dgain_calc_table(HI_U32 *pu32DgainLin, HI_U32 *pu32DgainDb)
{
    int i;
...
static HI_U32 sc1145_Again_limit(HI_U32 Again)
{
...
static HI_VOID sc1145_gains_update(HI_U32 u32Again, HI_U32 u32Dgain)
{
...
#if CMOS_SC1145_ISP_WRITE_SENSOR_ENABLE
    g_stSnsRegsInfo.astI2cData[2].u32Data = sc1145_Again_limit(u8AgainHigh << 4 | u8AgainLow);
	g_stSnsRegsInfo.astI2cData[3].u32Data = u8DgainReg;
#else
    sensor_write_register(0x3e09, sc1145_Again_limit(u8AgainHigh << 4 | u8AgainLow));
...
HI_S32 sc1145_init_ae_exp_function(AE_SENSOR_EXP_FUNC_S *pstExpFuncs)
{
    memset(pstExpFuncs, 0, sizeof(AE_SENSOR_EXP_FUNC_S));

    pstExpFuncs->pfn_cmos_get_ae_default    = sc1145_get_ae_default;
    pstExpFuncs->pfn_cmos_fps_set           = sc1145_fps_set;
    pstExpFuncs->pfn_cmos_slow_framerate_set= sc1145_slow_framerate_set;    
    pstExpFuncs->pfn_cmos_inttime_update    = sc1145_inttime_update;
    pstExpFuncs->pfn_cmos_gains_update      = sc1145_gains_update;
    pstExpFuncs->pfn_cmos_again_calc_table  = sc1145_again_calc_table;
    pstExpFuncs->pfn_cmos_dgain_calc_table  = sc1145_dgain_calc_table;
...
static HI_S32 sc1145_get_awb_default(AWB_SENSOR_DEFAULT_S *pstAwbSnsDft)
{
...
HI_S32 sc1145_init_awb_exp_function(AWB_SENSOR_EXP_FUNC_S *pstExpFuncs)
{
    memset(pstExpFuncs, 0, sizeof(AWB_SENSOR_EXP_FUNC_S));

    pstExpFuncs->pfn_cmos_get_awb_default = sc1145_get_awb_default;
...
{
    {100.000000f, 2.000000f, 0.037886f, 9.219183f, }, 

    {100.000000f, 2.000000f, 0.037232f, 9.371662f, }, 

    {211.000000f, 2.324282f, 0.039566f, 9.399966f, }, 

    {494.000000f, 2.693727f, 0.043625f, 9.732775f, }, 

    {894.000000f, 2.951338f, 0.050056f, 10.006947f, }, 

    {1223.000000f, 3.087426f, 0.052257f, 10.721448f, }, 

    {1505.000000f, 3.177536f, 0.069309f, 8.665545f, }, 
...
HI_U32 sc1145_get_isp_default(ISP_CMOS_DEFAULT_S *pstDef)
{
    if (HI_NULL == pstDef)
    {
    ...
    */
    ...
    pstDef->stSensorMaxResolution.u32MaxWidth  = SENSOR_SC1145_WIDTH;
    pstDef->stSensorMaxResolution.u32MaxHeight = SENSOR_SC1145_HEIGHT;

    return 0;
}

HI_U32 sc1145_get_isp_black_level(ISP_CMOS_BLACK_LEVEL_S *pstBlackLevel)
{
   // HI_S32  i;
...
HI_VOID sc1145_set_pixel_detect(HI_BOOL bEnable)
{
...
HI_VOID sc1145_set_wdr_mode(HI_U8 u8Mode)
{
    bInit = HI_FALSE;
...
HI_U32 sc1145_get_sns_regs_info(ISP_SNS_REGS_INFO_S *pstSnsRegsInfo)
{
...
static HI_S32 sc1145_set_image_mode(ISP_CMOS_SENSOR_IMAGE_MODE_S *pstSensorImageMode)
{
...
void sc1145_reg_init(void)
{
    ...
    SENSOR_I2C_WRITE(0x3780,0x02);//1145
    SENSOR_I2C_WRITE(0x3207,0xe2);//1145
...
HI_S32 sc1145_init_sensor_exp_function(ISP_SENSOR_EXP_FUNC_S *pstSensorExpFunc)
{
    memset(pstSensorExpFunc, 0, sizeof(ISP_SENSOR_EXP_FUNC_S));

    pstSensorExpFunc->pfn_cmos_sensor_init = sc1145_reg_init;
    //pstSensorExpFunc->pfn_cmos_sensor_exit = sensor_exit;
    pstSensorExpFunc->pfn_cmos_sensor_global_init = sc1145_global_init;
    pstSensorExpFunc->pfn_cmos_set_image_mode = sc1145_set_image_mode;
    pstSensorExpFunc->pfn_cmos_set_wdr_mode = sc1145_set_wdr_mode;
    
    pstSensorExpFunc->pfn_cmos_get_isp_default = sc1145_get_isp_default;
    pstSensorExpFunc->pfn_cmos_get_isp_black_level = sc1145_get_isp_black_level;
    pstSensorExpFunc->pfn_cmos_set_pixel_detect = sc1145_set_pixel_detect;
    pstSensorExpFunc->pfn_cmos_get_sns_reg_info = sc1145_get_sns_regs_info;
...
int sc1145_register_callback(void)
{
    ISP_DEV IspDev = 0;
    HI_S32 s32Ret;
    ALG_LIB_S stLib;
    ...
    sc1145_init_sensor_exp_function(&stIspRegister.stSnsExp);
    ...
    sc1145_init_ae_exp_function(&stAeRegister.stSnsExp);
    ...
    sc1145_init_awb_exp_function(&stAwbRegister.stSnsExp);
...
int sc1145_unregister_callback(void)
{
    ISP_DEV IspDev = 0;
    HI_S32 s32Ret;
    ALG_LIB_S stLib;
...
int SmartSens_SC1145_init(SENSOR_DO_I2CRD do_i2c_read, 
...
//	af_register_callback(pAfRegister);
	...
	printf("SmartSens SC1145 sensor 720P25fps init success!\n");
	return s32Ret;
}
...
int SC1145_set_mirror(bool mirror){
	sensor_mirror = mirror;
	if(sensor_mirror == false && sensor_flip == false){//normal
		SENSOR_I2C_WRITE(0x3781,0x10);	
		SENSOR_I2C_WRITE(0x3211,0x68);	
		SENSOR_I2C_WRITE(0x321c,0x00);
		SENSOR_I2C_WRITE(0x321d,0x00);
	}else if(sensor_mirror == true && sensor_flip == false){//mirror
		SENSOR_I2C_WRITE(0x3781,0x08);	
		SENSOR_I2C_WRITE(0x3211,0x61);	
		SENSOR_I2C_WRITE(0x321c,0x00);
		SENSOR_I2C_WRITE(0x321d,0x01);

	}else if(sensor_mirror == false && sensor_flip == true){//flip
		SENSOR_I2C_WRITE(0x3781,0x10);	
		SENSOR_I2C_WRITE(0x3211,0x60);	
		SENSOR_I2C_WRITE(0x321c,0x40);
		SENSOR_I2C_WRITE(0x321d,0x00);
...
int SC1145_get_resolution(uint32_t *ret_width, uint32_t *ret_height)
{
	if(ret_width && ret_height){
		*ret_width = SENSOR_SC1145_WIDTH;
		*ret_height = SENSOR_SC1145_HEIGHT;
		return 0;
	}
	return -1;
}

bool SENSOR_SC1145_probe()
{
	...
	if(ret_data1 == SC1145_CHECK_DATA_LSB && ret_data2 == SC1145_CHECK_DATA_MSB){
		//set i2c pinmux
...
int SC1145_get_sensor_name(char *sensor_name)
{
    if(sensor_name != NULL) {
