...
#define AR0230_CHECK_DATA_LSB  (0x0)   //FIXME
#define AR0230_CHECK_DATA_MSB  (0x23)
#define SENSOR_AR0230_WIDTH 1920
#define SENSOR_AR0230_HEIGHT 1080
...
#ifdef INIFILE_CONFIG_MODE
static HI_S32 ar0230_get_ae_default(AE_SENSOR_DEFAULT_S *pstAeSnsDft)
{
...
static HI_VOID ar0230_fps_set(HI_FLOAT f32Fps, AE_SENSOR_DEFAULT_S *pstAeSnsDft)
{	 
...
static HI_VOID ar0230_slow_framerate_set(HI_U32 u32FullLines,
...
static HI_VOID ar0230_inttime_update(HI_U32 u32IntTime)
{
...
static HI_VOID ar0230_again_calc_table(HI_U32 *pu32AgainLin, HI_U32 *pu32AgainDb)
{
    int i;
    HI_U32 u32InTimes;
...
static HI_VOID ar0230_gains_update(HI_U32 u32Again, HI_U32 u32Dgain)
{
...
HI_S32 ar0230_init_ae_exp_function(AE_SENSOR_EXP_FUNC_S *pstExpFuncs)
{
    memset(pstExpFuncs, 0, sizeof(AE_SENSOR_EXP_FUNC_S));

    pstExpFuncs->pfn_cmos_get_ae_default    = ar0230_get_ae_default;
    pstExpFuncs->pfn_cmos_fps_set           = ar0230_fps_set;
    pstExpFuncs->pfn_cmos_slow_framerate_set= ar0230_slow_framerate_set;    
    pstExpFuncs->pfn_cmos_inttime_update    = ar0230_inttime_update;
    pstExpFuncs->pfn_cmos_gains_update      = ar0230_gains_update;
    pstExpFuncs->pfn_cmos_again_calc_table  = ar0230_again_calc_table;
...
static HI_S32 ar0230_get_awb_default(AWB_SENSOR_DEFAULT_S *pstAwbSnsDft)
{
    HI_U8 i;
...
HI_S32 ar0230_init_awb_exp_function(AWB_SENSOR_EXP_FUNC_S *pstExpFuncs)
{
    memset(pstExpFuncs, 0, sizeof(AWB_SENSOR_EXP_FUNC_S));

    pstExpFuncs->pfn_cmos_get_awb_default = ar0230_get_awb_default;
...
HI_U32 ar0230_get_isp_default(ISP_CMOS_DEFAULT_S *pstDef)
{   
    if (HI_NULL == pstDef)
    {
    ...
    pstDef->stSensorMaxResolution.u32MaxWidth  = SENSOR_AR0230_WIDTH;
    pstDef->stSensorMaxResolution.u32MaxHeight = SENSOR_AR0230_HEIGHT;
...
HI_U32 ar0230_get_isp_black_level(ISP_CMOS_BLACK_LEVEL_S *pstBlackLevel)
{
    HI_S32  i;
...
HI_VOID ar0230_set_pixel_detect(HI_BOOL bEnable)
{
...
HI_VOID ar0230_set_wdr_mode(HI_U8 u8Mode)
{
    bInit = HI_FALSE;
...
static HI_S32 ar0230_set_image_mode(ISP_CMOS_SENSOR_IMAGE_MODE_S *pstSensorImageMode)
{
...
HI_U32 ar0230_get_sns_regs_info(ISP_SNS_REGS_INFO_S *pstSnsRegsInfo)
{
...
int  ar0230_sensor_set_inifile_path(const char *pcPath)
{
...
HI_VOID ar0230_sensor_global_init()
{   
...
void ar0230_reg_init()
{
	...
	SENSOR_I2C_WRITE(0x3088, 0x8242); 
	...
	SENSOR_I2C_WRITE(0x3086, 0x8F03); 
	...
	SENSOR_I2C_WRITE(0x3086, 0x063F); 
	...
	SENSOR_I2C_WRITE(0x3086, 0x302A); 
	SENSOR_I2C_WRITE(0x3086, 0xF23F); 
	SENSOR_I2C_WRITE(0x3086, 0x1029); 
	...
	SENSOR_I2C_WRITE(0x3086, 0x2A98); 
	SENSOR_I2C_WRITE(0x3086, 0x8E00); 
	SENSOR_I2C_WRITE(0x3086, 0x769C); 
	SENSOR_I2C_WRITE(0x3086, 0x779C); 
	SENSOR_I2C_WRITE(0x3086, 0x4644); 
	SENSOR_I2C_WRITE(0x3086, 0x1616); 
	SENSOR_I2C_WRITE(0x3086, 0x907A); 
	...
	SENSOR_I2C_WRITE(0x3086, 0x1244); 
	SENSOR_I2C_WRITE(0x3086, 0x4B2C); 
	...
	SENSOR_I2C_WRITE(0x30B0, 0x1118); 
	...
	SENSOR_I2C_WRITE(0x300A, 1351	);	 
	SENSOR_I2C_WRITE(0x300C, 1118	);	 
	SENSOR_I2C_WRITE(0x3012, 1349 );	
	...
	SENSOR_I2C_WRITE(0x30BA, 0x769C );
	SENSOR_I2C_WRITE(0x31E0, 0x0200 );
	SENSOR_I2C_WRITE(0x318C, 0x0000 );
	...
	SENSOR_I2C_WRITE(0x3200, 0x0000 );    
	...
	SENSOR_I2C_WRITE(0x3178, 0xFE80 );// DELTA_DK_ADJUST_RED offset of -2
	SENSOR_I2C_WRITE(0x3176, 0xFE80 );// DELTA_DK_ADJUST_GREENR offset of -2
	SENSOR_I2C_WRITE(0x317A, 0xFF80 );// DELTA_DK_ADJUST_BLUE offset of -1
	SENSOR_I2C_WRITE(0x317C, 0xFF80 );// DELTA_DK_ADJUST_GREENB offset of -1
										 
	SENSOR_I2C_WRITE(0x3064, 0x1802 );//Disable Embedded Data and Stats
	SENSOR_I2C_WRITE(0x31AE, 0x0304 );
	SENSOR_I2C_WRITE(0x31C6, 0x0400 );//HISPI_CONTROL_STATUS: HispiSP
	SENSOR_I2C_WRITE(0x306E, 0x9210 );//DATAPATH_SELECT[9]=1 VDD_SLVS=1.8V 
										 
	SENSOR_I2C_WRITE(0x301A, 0x005C );//RESET_REGISTER
	delay_ms(33);
...
HI_S32 ar0230_init_sensor_exp_function(ISP_SENSOR_EXP_FUNC_S *pstSensorExpFunc)
{
    memset(pstSensorExpFunc, 0, sizeof(ISP_SENSOR_EXP_FUNC_S));

    pstSensorExpFunc->pfn_cmos_sensor_init = ar0230_reg_init;
 //   pstSensorExpFunc->pfn_cmos_sensor_exit = sensor_exit;
    pstSensorExpFunc->pfn_cmos_sensor_global_init = ar0230_sensor_global_init;
    pstSensorExpFunc->pfn_cmos_set_image_mode = ar0230_set_image_mode;
    pstSensorExpFunc->pfn_cmos_set_wdr_mode = ar0230_set_wdr_mode;
    
    pstSensorExpFunc->pfn_cmos_get_isp_default = ar0230_get_isp_default;
    pstSensorExpFunc->pfn_cmos_get_isp_black_level = ar0230_get_isp_black_level;
    pstSensorExpFunc->pfn_cmos_set_pixel_detect = ar0230_set_pixel_detect;
    pstSensorExpFunc->pfn_cmos_get_sns_reg_info = ar0230_get_sns_regs_info;
...
int ar0230_sensor_register_callback(void)
{
    ISP_DEV IspDev = 0;
    HI_S32 s32Ret;
    ALG_LIB_S stLib;
    ...
    ar0230_init_sensor_exp_function(&stIspRegister.stSnsExp);
    ...
    ar0230_init_ae_exp_function(&stAeRegister.stSnsExp);
    ...
    ar0230_init_awb_exp_function(&stAwbRegister.stSnsExp);
...
int ar0230_sensor_unregister_callback(void)
{
    ISP_DEV IspDev = 0;
    HI_S32 s32Ret;
    ALG_LIB_S stLib;
...
int APTINA_AR0230_init(SENSOR_DO_I2CRD do_i2c_read, 
...
//	ar0230_reg_init();
	...
	ar0230_sensor_register_callback();
//	af_register_callback(pAfRegister);
	...
	printf("Aptina AR0230 sensor 1080P30fps init success!\n");
	return s32Ret;
}

int AR0230_get_resolution(uint32_t *ret_width, uint32_t *ret_height)
{
    if(ret_width && ret_height){
        *ret_width = SENSOR_AR0230_WIDTH;
        *ret_height = SENSOR_AR0230_HEIGHT;
        return 0;
    }
    return -1;
}

bool SENSOR_AR0230_probe()
{
    uint16_t ret_data1 = 0;
    uint16_t ret_data2 = 0;
	
    SENSOR_I2C_READ(0x3060, &ret_data1);
    SENSOR_I2C_READ(0x3061, &ret_data2);
	
    if(ret_data1 == AR0230_CHECK_DATA_LSB && ret_data2 == AR0230_CHECK_DATA_MSB){
		//set i2c pinmux
...
int AR0230_get_sensor_name(char *sensor_name)
{
    if(sensor_name != NULL) {
