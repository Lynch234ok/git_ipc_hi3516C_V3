...
/*****************************************************************************
 Description     : Bind the VI,VO or other device to the pciv channel
 Input           : pcivChn    ** The pciv channel id
                   pBindObj   ** The bind object
 Output          : None
 Return Value    : HI_SUCCESS if success.
                   HI_FAILURE if failure

 See Also        : HI_MPI_PCIV_UnBind
*****************************************************************************/
HI_S32 HI_MPI_PCIV_Bind(PCIV_CHN pcivChn, PCIV_BIND_OBJ_S *pBindObj);

/*****************************************************************************
 Description     : Unbind the VI,VO or other device to the pciv channel
 Input           : pcivChn    ** The pciv channel id
                   pBind      ** The bind object
 Output          : None
 Return Value    : HI_SUCCESS if success.
                   HI_FAILURE if failure

 See Also        : HI_MPI_PCIV_Bind
*****************************************************************************/
HI_S32 HI_MPI_PCIV_UnBind(PCIV_CHN pcivChn, PCIV_BIND_OBJ_S *pBind);

/*****************************************************************************
 Description     : Enum the bind object of the pciv channel.
 Input           : pcivChn    ** The pciv channel id
                   stBind     ** The bind object array
 Output          : None
 Return Value    : HI_SUCCESS if success.
                   HI_FAILURE if failure
...
HI_S32 HI_MPI_PCIV_EnumBindObj(PCIV_CHN pcivChn, 
    PCIV_BIND_OBJ_S astBindObj[PCIV_MAX_BINDOBJ], HI_U32 *pu32Count);
