...
#define PCIV_MAX_BINDOBJ 32
#define PCIV_MAX_CHIPNUM 32
#define PCIV_MAX_CHN_NUM 128
...
#define HI_ERR_PCIV_NOT_SUPPORT         HI_DEF_ERR(HI_ID_PCIV, EN_ERR_LEVEL_ERROR, EN_ERR_NOT_SURPPORT)
