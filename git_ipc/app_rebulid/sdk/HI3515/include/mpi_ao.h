...
HI_S32 HI_MPI_AO_BindAi(AUDIO_DEV AoDev, AO_CHN AoChn, AUDIO_DEV AiDev, AI_CHN AiChn);
HI_S32 HI_MPI_AO_UnBindAi(AUDIO_DEV AoDev, AO_CHN AoChn, AUDIO_DEV AiDev, AI_CHN AiChn);
