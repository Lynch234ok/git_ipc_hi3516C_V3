...
extern emSENSOR_MODEL hi_isp_api_get_sensor_model(char *);
...
extern void hi_isp_api_get_starlight_mode(bool *enable);
extern void hi_isp_api_set_colortoblack_range(uint8_t colortoblackrange);
extern uint8_t hi_isp_api_get_colortoblack_range(void);
...
extern int hi_isp_api_get_wdr_mode (uint8_t *bEnable); //wdr yang
extern int hi_isp_api_get_cur_fps();
extern void hi_isp_api_get_daynight_mode(uint8_t *daynight_mode);
