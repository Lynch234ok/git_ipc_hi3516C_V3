...
extern int HI_ISP_cfg_set_awb(int scene, int isDaylight, LpIspCfgAttr ispCfgAttr);
extern int HI_ISP_cfg_get_awb(int scene, int isDaylight, LpIspCfgAttr ispCfgAttr);
