...
{
    H265E_REF_TYPE_E enRefType;   /* FrameType in advanced frame skipping reference mode*/

    HI_U32  u32PicBytesNum;       /* the coded picture stream byte number */
    HI_U32  u32PicCnt;            /* Picture Count */
	HI_U32  u32StartQp;	          /* the start Qp of encoded frames */
	HI_U32  u32MeanQp;            /* the mean Qp of encoded frames */
    HI_BOOL bPSkip;

    HI_U32 	u32ResidualBitNum;    /* residual bits number */
    HI_U32 	u32HeadBitNum;        /* header bits number */
    HI_U32 	u32MadiVal;	          /* madi */
    HI_U32 	u32MadpVal;	          /* madp */
...
{
     HI_U8   u8LargeThumbNailNum;      /*Default:0,Range:[0,2];0:not support MPF*/
