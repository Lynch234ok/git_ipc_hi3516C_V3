...
HI_S32 HI_MPI_VPSS_SetGrpSharpenEx (VPSS_GRP VpssGrp, VPSS_GRP_SHARPEN_ATTR_EX_S *pstGrpSharpenAttrEx);
HI_S32 HI_MPI_VPSS_GetGrpSharpenEx (VPSS_GRP VpssGrp, VPSS_GRP_SHARPEN_ATTR_EX_S *pstGrpSharpenAttrEx);
...
HI_S32 HI_MPI_VPSS_GetGrpNRCParam(VPSS_GRP VpssGrp, VPSS_GRP_NRC_PARAM_S *pstVpssNrCParam);
HI_S32 HI_MPI_VPSS_SetGrpNRCParam(VPSS_GRP VpssGrp, VPSS_GRP_NRC_PARAM_S *pstVpssNrCParam);
