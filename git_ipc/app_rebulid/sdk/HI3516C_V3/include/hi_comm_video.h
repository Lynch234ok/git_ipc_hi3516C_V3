...
typedef enum hiLDC_WORK_MODE_E
{
    LDC_WORK_MODE_ENHANCED 	= 0,  	/* Enhanced mode, strong correction ability */
    LDC_WORK_MODE_NORMAL	= 1,	/* Normal mode, weak correction capability */
