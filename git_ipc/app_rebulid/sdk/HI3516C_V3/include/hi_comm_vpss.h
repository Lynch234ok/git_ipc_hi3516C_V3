...
typedef struct hiVPSS_GRP_SHARPEN_ATTR_EX_S
{
   HI_BOOL bEnable;
   VPSS_GRP_SHARPEN_ATTR_S stSharpenAttr;
} VPSS_GRP_SHARPEN_ATTR_EX_S;
...
typedef struct
{
    HI_U8  TFS :  4, TSS  : 4, MDDZ;
    HI_U16 TSDZ: 10, TFR1 : 5, TFR2 : 1;
    HI_U16 STR :  5, TFR0 : 5, _rb_ : 2, TSR : 4;
} tV16cTFy;
...
typedef struct hiNRX_PARAM_V2_S
{
    ...
    HI_U8  kRfr : 6, kOut : 1, _rb0_ : 1;

    HI_U8  SlpEx : 1, Recommend : 1, Update : 1, _rb1_ : 5;
} NRX_PARAM_V2_S;

/****************************VPSS 3DNR X interface ***********end*********************/


/****************************VPSS 3DNR C interface ***********start*********************/
typedef struct
{
    tV16cSFySub SFySub[8];
    tV16cSFyPro SFyPro[6];
    HI_U8 kProDD[2];
    HI_U8 VRTO[6];
} tV16cCSFy;
...
/* 3DNR C interface for Hi3516CV300  */
typedef struct hiNRC_PARAM_V2_S
{
    tV16cCIEy  IEy;
    tV16cCSFy  SFy;
    tV16cMDy  MDy[6];
...
typedef struct hiVPSS_GRP_NRC_PARAM_S
{
    VPSS_NR_VER_E enNRVer;
    union
    {
        NRC_PARAM_V2_S stNRCParam_V2;   /* interface C V2 for Hi3516CV300 */
    };

}VPSS_GRP_NRC_PARAM_S;
