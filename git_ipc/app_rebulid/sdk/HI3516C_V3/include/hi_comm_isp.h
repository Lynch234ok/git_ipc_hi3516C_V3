...
{
	HI_U8 au8DePurpleCrStr[ISP_EXP_RATIO_STRENGTH_NUM];   /*RW, Range: [0,8]*/
	HI_U8 au8DePurpleCbStr[ISP_EXP_RATIO_STRENGTH_NUM];   /*RW, Range: [0,8]*/
