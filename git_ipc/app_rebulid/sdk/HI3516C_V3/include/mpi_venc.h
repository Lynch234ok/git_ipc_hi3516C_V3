...
HI_S32 HI_MPI_VENC_SetVencAdvancedParam(VENC_CHN VeChn,VENC_PARAM_ADVANCED_S *pstAdvancedParam);
HI_S32 HI_MPI_VENC_GetVencAdvancedParam(VENC_CHN VeChn,VENC_PARAM_ADVANCED_S *pstAdvancedParam);
...
HI_S32 HI_MPI_VENC_SetMPFCfg(VENC_CHN VeChn, const VENC_MPF_CFG_S *pstMpfCfg);
HI_S32 HI_MPI_VENC_GetMPFCfg(VENC_CHN VeChn,  VENC_MPF_CFG_S * pstMpfCfg);
