...
extern int HI_SDK_ISP_get_starlight_mode(bool *enable);
...
extern int  HI_SDK_ISP_get_colortoblack_range(uint8_t *val);
extern int HI_SDK_ISP_set_colortoblack_range(uint8_t colortoblackrange);
