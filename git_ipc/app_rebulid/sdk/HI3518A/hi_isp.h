...
extern int HI_SDK_ISP_get_sensor_model(emSENSOR_MODEL *ret_value);
...
extern uint32_t HI_SDK_ISP_get_gain(void);
extern void HI_SDK_ISP_set_AF_attr(stSensorAfAttr *pAfAttr);
