...
emSENSOR_MODEL hi_isp_api_get_sensor_model()
{
	emSENSOR_MODEL ret_sensor_model;
	HI_SDK_ISP_get_sensor_model(&ret_sensor_model);
...
int hi_isp_api_set_ircut_switch_array(float *array)
{
	return hi_isp_api_set_ircut_switch_to_day_array(array);
}
