...
typedef enum
{
    ...
    INPUT_MODE_CMOS_18V     = 0x3,              /* CMOS 1.8V */
    INPUT_MODE_CMOS_33V     = 0x4,              /* CMOS 3.3V */
    INPUT_MODE_HISPI        = 0x5,              /* HISPI */
    INPUT_MODE_BUTT
}input_mode_t;
...
typedef struct
{
    ...
    union
    {
        ...
        lvds_dev_attr_t     lvds_attr;              /* for LVDS/SUBLVDS/SIPSI configuration */
    };
}combo_dev_attr_t;
