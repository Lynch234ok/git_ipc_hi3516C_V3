...
extern int SPOOK_add_service(const char *name, SPOOK_TASK_PROBE_FUNC do_probe, SPOOK_TASK_LOOP_FUNC do_loop);
extern int SPOOK_remove_service(const char *name);
...
extern in_port_t SPOOK_listen_port();
