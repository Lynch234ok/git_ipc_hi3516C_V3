...
//#define TEST_WAV	"./web/audio/PCM/pcm-44100-16-mono.wav"
//#define TEST_WAV	"./web/audio/PCM/pcm-8-mono.wav"
//#define TEST_WAV	"./web/audio/PCM/pcm-8-stereo.wav"
//#define TEST_WAV	"./web/audio/PCM/pcm-16-mono.wav"
//#define TEST_WAV	"./web/audio/PCM/pcm-16-stereo.wav"
#define TEST_WAV	"alaw-8000-mono.wav"
//#define TEST_WAV	"./web/audio/ULaw/ulaw-8000-mono.wav"
...
int WAV_init(char *name);
void WAV_get_config2(int *format,unsigned int *samplerate,int *samplesize,int *channel);
int WAV_read(unsigned char *buf,int buf_size);
unsigned char WAV_get_config();
int WAV_get_datarate();
