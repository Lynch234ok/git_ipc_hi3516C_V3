...
#define HT_RTSP_EVENT_CONNECT_OK 		(4)
#define HT_RTSP_EVENT_DISCONNECT_OK 		(5)
#define HT_RTSP_EVENT_DESTROYED 		(6)
#define HT_RTSP_EVENT_REQ_PLAY 		(7)
#define HT_RTSP_EVENT_REQ_PAUSE 		(8)
#define HT_RTSP_EVENT_DATA_RECEIVED 		(9)
#define HT_RTSP_EVENT_AUTH_REQUIRE 		(10)
#define HT_RTSP_EVENT_ERROR_OCCUR 		(11)
#define HT_RTSP_EVENT_RTCP_SENDER_REPORT 		(12)
#define HT_RTSP_EVENT_RTCP_RECEIVER_REPORT 		(13)
...
#define HT_TYPE_H265 (97)
#define HT_TYPE_H264 (96)
...
typedef struct _MINIRTSP_RTSP_CFG
{
	char			serverip[32];	// bind server ip addr
	...
	int output_num;	
	RTSP_OUTPUT   output[5]; 		// the audio & video output configuration
} stMINIRTSP_CFG,*lpMINIRTSP_CFG;

typedef int(*MINIRTSP_SERVER_GET_PARAM)(lpMINIRTSP_CFG cfg);
void MINIRTSP_server_get_param_hook(MINIRTSP_SERVER_GET_PARAM hook);
*/
...
#define MINIRTSP_LIB_VERSION        (21U)
