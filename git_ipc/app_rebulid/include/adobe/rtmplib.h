...
#define RTMP_ENABLE_AUTH
#define RTMP_AUTH_NONCE

#define RTMP_CHUNK_SIZE			(1262)
...
typedef int (*fRTMP_GET_PWD_BY_NAME)(const char *name, char *ret_pwd, int ret_size);
void RTMP_set_auth_hook(fRTMP_GET_PWD_BY_NAME hook);
