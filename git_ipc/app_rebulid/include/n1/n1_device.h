 ...
 */
NK_API NK_Boolean
NK_N1Device_SendH264(NK_Int sessionid, NK_Int chid, NK_Int streamid, NK_UInt64 ts_us, NK_Boolean keyFrame, NK_PVoid data, NK_Size len);

/**
 * @macro
 *  直播发送方法，只用于直播视频，并由模块定义时间戳。
 */
#define NK_N1Device_SendNoTsH264(__chid, ___streamid, __keyFrame, __data, __len) \
	NK_N1Device_SendH264(0, __chid, ___streamid, NK_N1Device_UptimeMacro(), __keyFrame, __data, __len);
 ...
 */
NK_API NK_Boolean
NK_N1Device_SendHEVC(NK_Int sessionid, NK_Int chid, NK_Int streamid, NK_UInt64 ts_us, NK_Boolean keyFrame, NK_PVoid data, NK_Size len);
 ...
 *  直播发送方法，只用于直播视频，并由模块定义时间戳。
 */
#define NK_N1Device_SendNoTsHEVC(__chid, ___streamid, __keyFrame, __data, __len) \
	NK_N1Device_SendHEVC(0, __chid, ___streamid, NK_N1Device_UptimeMacro(), __keyFrame, __data, __len);
