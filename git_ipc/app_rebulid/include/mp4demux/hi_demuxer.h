...
{
    HI_U16 u16VidStreamId;   /**< Video stream ID.  */
    HI_U16 u16AudStreamId;   /**< Audio stream ID. */
...
typedef struct hiFORMAT_FILE_INFO_S
{
    ...
    HI_S32  s32UsedDataIndex;
    HI_FORMAT_VIDEO_TYPE_E enVideoType;
} HI_FORMAT_FILE_INFO_S;

typedef struct hiFORMAT_FUN_S
{
    HI_S32 (*fmt_open)(HI_HANDLE* hFmt, const HI_CHAR* pszFileName);
    HI_S32 (*fmt_close)(HI_HANDLE hFmt);
    HI_S32 (*fmt_read)(HI_HANDLE hFmt, HI_FORMAT_PACKET_S* pstFmtFrame);
    HI_S32 (*fmt_free)(HI_HANDLE hFmt, HI_FORMAT_PACKET_S* pstFmtFrame);
    HI_S32 (*fmt_seek)(HI_HANDLE hFmt, HI_S32 s32StreamIndex, HI_S64 s64MSec);
    HI_S32 (*fmt_probe)(HI_HANDLE hFmt);
    HI_S32 (*fmt_getinfo)(HI_HANDLE hFmt, HI_FORMAT_FILE_INFO_S* pstFmtInfo);
    HI_S32 (*fmt_setattr)(HI_HANDLE hFmt, HI_FORMAT_MEDIA_ATTR_S* pstFmtInfo);
}HI_FORMAT_FUN_S;
