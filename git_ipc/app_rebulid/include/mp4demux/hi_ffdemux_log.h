/**
  ...
  * @date      2016.06.29
  */
#ifndef __HI_FFDEMUX_LOG_H__
#define __HI_FFDEMUX_LOG_H__
...
*/
HI_S32 HI_FFDEMUX_SetEnabledLevel(HI_FFDEMUX_LOG_LEVEL_E enLevel);
...
*   @retval  0 success,others failed
*/
HI_S32 HI_FFDEMUX_SetOutputFunc(HI_FFDEMUX_OUTPUT_FUNC pFunc);
...
*   @retval  0 success,others failed
*/
HI_S32 HI_FFDEMUX_Printf(const HI_CHAR* pszModName, HI_FFDEMUX_LOG_LEVEL_E enLevel, const HI_CHAR* pszFmt, ...);
